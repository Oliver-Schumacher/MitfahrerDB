...
namespace MitfahrerDB_Backend.Migrations
{
    ...
    [Migration("20221109105520_LocationsRelationship")]
    partial class LocationsRelationship
    {
            ...
            modelBuilder.Entity("MitfahrerDB_Backend.Trip", b =>
                {
                    ...
                    b.HasOne("MitfahrerDB_Backend.Location", "LocationEnd")
                        .WithOne()
                        .HasForeignKey("MitfahrerDB_Backend.Trip", "LocationEndId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MitfahrerDB_Backend.Location", "LocationStart")
                        .WithOne()
                        .HasForeignKey("MitfahrerDB_Backend.Trip", "LocationStartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
